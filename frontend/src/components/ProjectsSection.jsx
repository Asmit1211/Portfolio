...
import { Github, ExternalLink, Clock, CheckCircle, Calendar, ChevronRight } from 'lucide-react';
...
const ProjectsSection = () => {
  ...
  return (
    <section id="projects" className="py-20 bg-gradient-to-br from-slate-50 via-white to-indigo-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-8">
            A showcase of my technical projects, from web applications to software engineering concepts
          </p>
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Badge className={`${getStatusColor(selectedProject.status)} border font-medium`}>
        ...
        <div className="text-center mt-12">
          <div className="inline-flex items-center space-x-4 p-6 bg-gradient-to-r from-slate-800 to-slate-700 rounded-xl text-white">
            ...
            <div className="text-left">
              ...
              <p className="text-slate-300 text-sm">Explore my complete code repository</p>
            </div>
            <Button
              variant="secondary"
              onClick={() => window.open('https://github.com/Asmit1211', '_blank')}
